...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_s1-spine1_Ethernet3 | - | 192.168.51.5/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_s1-spine2_Ethernet3 | - | 192.168.51.7/31 | default | 1500 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 192.168.246.4/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 192.168.236.3/32 |
| Loopback100 | DIAG_VRF_bluevrf | bluevrf | 10.255.1.4/32 |
...
| Vlan3099 | MLAG_L3_VRF_bluevrf | bluevrf | 1500 | False |
...
| Vlan3099 |  bluevrf  |  10.255.251.1/31  |  -  |  -  |  -  |  -  |
...
| 192.168.51.4 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.51.6 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.246.1 | 65001 | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - | - | - | - |
| 192.168.246.2 | 65001 | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - | - | - | - |
| 10.255.251.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | bluevrf | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| bluevrf | 192.168.246.4:100 | 100:100 | - | - | learned | 2300-2301 |
| ExternalNetwork | 192.168.246.4:30002 | 30002:30002 | - | - | learned | 20 |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| bluevrf | 192.168.246.4:100 | connected |
...
router bgp 65101
   ...
   neighbor 192.168.51.4 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.51.4 remote-as 65001
   neighbor 192.168.51.4 description s1-spine1_Ethernet3
   neighbor 192.168.51.6 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.51.6 remote-as 65001
   neighbor 192.168.51.6 description s1-spine2_Ethernet3
   ...
   vrf bluevrf
      ...
      router-id 192.168.246.4
      neighbor 10.255.251.0 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.251.0 description s1-leaf1_Vlan3099
...
```eos
!
ip address virtual source-nat vrf bluevrf address 10.255.1.4
```
