...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_S1-SPINE1_Ethernet2 | routed | - | 192.168.51.1/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_LINK_TO_S1-SPINE2_Ethernet2 | routed | - | 192.168.51.3/31 | default | 1500 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 192.168.246.3/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 192.168.236.3/32 |
| Loopback100 | bluevrf_VTEP_DIAGNOSTICS | bluevrf | 10.255.1.3/32 |
...
| 192.168.51.0 | 64999 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.51.2 | 64999 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 20 | 192.168.246.3:30002 | 30002:30002 | - | - | learned |
| 2300 | 192.168.246.3:32300 | 32300:32300 | - | - | learned |
| 2301 | 192.168.246.3:32301 | 32301:32301 | - | - | learned |
...
router bgp 65101
   ...
   !
   vlan 2300
      rd 192.168.246.3:32300
      route-target both 32300:32300
      redistribute learned
   !
   vlan 2301
      rd 192.168.246.3:32301
