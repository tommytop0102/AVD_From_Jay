...
--------------- -------------------- ---------- ------------ ---------- -------
Ethernet2       192.168.51.5/31      up         up              1500           
Ethernet3       192.168.51.7/31      up         up              1500           
Loopback0       192.168.246.4/32     up         up             65535           
...
Vlan3099        10.255.251.1/31      up         up              1500           
...
---------- --------------------------- ---------------------- ---
Et1           s1-leaf1.tsmc.com.tw        Ethernet1           120
Et2           s1-spine1.tsmc.com.tw       Ethernet3           120
Et3           s1-spine2.tsmc.com.tw       Ethernet3           120
Et4           s1-host1.atd.lab            Ethernet2           120
Et6           s1-leaf1.tsmc.com.tw        Ethernet6           120
```
## show running-config

```
! Command: show running-config
! device: s1-leaf2 (cEOSLab, EOS-4.32.1F-37313256.4321F (engineering build))
!
no aaa root
!
