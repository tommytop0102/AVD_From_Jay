...
--------------- -------------------- ---------- ------------ ---------- -------
Ethernet2       192.168.51.13/31     up         up              1500           
Ethernet3       192.168.51.15/31     up         up              1500           
Ethernet4       10.192.192.21/24     up         up              9214           
Loopback0       192.168.246.6/32     up         up             65535           
...
Vlan3099        10.255.251.5/31      up         up              1500           
...
---------- --------------------------- ---------------------- ---
Et1           s1-leaf3.tsmc.com.tw        Ethernet1           120
Et2           s1-spine1.tsmc.com.tw       Ethernet5           120
Et3           s1-spine2.tsmc.com.tw       Ethernet5           120
Et4           s1-host2.atd.lab            Ethernet2           120
Et6           s1-leaf3.tsmc.com.tw        Ethernet6           120
```
## show running-config

```
! Command: show running-config
! device: s1-leaf4 (cEOSLab, EOS-4.32.1F-37313256.4321F (engineering build))
!
no aaa root
!
